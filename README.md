...
Once UV is installed, the project dependencies can be acquired by running the command `uv sync`. 
The program can then be run by executing the command `uv run main`.
